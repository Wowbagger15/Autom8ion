...
param(
    [string]
    $me  = "FPC Dr. S. van Mesdag - I&A - Systeem informatie"
    ,
    [string]
    $bye = "Gereed. Dit venster mag gesloten worden."
    ,
<#
...
function copy-value {
    process {
$this.text, $this.font -join ' - ' | write-host;
...
function get-image {
    ...
    begin {
        ...
        #*   $b = get-content -AsByteStream 'C:\Users\Mesdag\OneDrive - Stichting FPC Dr. S. van Mesdag\Bureaublad\Laptop_128x128.png';
        #*   $l = [system.convert]::ToBase64String( $b );
        #*   0..[math]::floor( $l.length / 4096 ) |% { $l.substring( $_ * 4096, ( [math]::min( $l.length - $_ * 4096, 4096 ) ) ) } | enclose-string '''' | set-clipboard;

        $_sources = @{
            form1 = @(
                        ''
                        ''
                        ''
                        ''
                        ''
                        ''
                        ''
                        ''
                        ''
            ) -join ''
            form = @(
...
function popUP {
    begin {
        ...
        try {
            $_canvas                    = [System.Windows.Forms.Form]@{
                clientSize              = [System.Drawing.Size]::new( $width, <# $height #> $_margin + 0 + $_margin )
                backColor               = $background
                text                    = $me
                maximizeBox             = $false
                minimizeBox             = $false
        ...
        try {
            ...
            $_value = [System.Windows.Forms.TextBox]@{
                ...
                readonly                = $true
                borderStyle             = "none"
            #   font                    = [System.Drawing.Font]::new( $_label.font.name, $_label.font.size, [System.Drawing.FontStyle]::Bold );
                font                    = $_label.font
            #   foreColor               = '#2B130D'
                foreColor               = [System.Drawing.Color]::Black
            #   backColor               = $_canvas.backColor
                backColor               = '#E5D9D5'
                autoSize                = $false
                wordWrap                = $false
            };
        ...
        $_table |% {
            ...
            try {
                ...
                if ( $_.pre ) {
                #   $_val.font  = [System.Drawing.Font]::new( 'Lucida Sans Typewriter', 8 );
...
# region main
"Start {0} version {1} ..." -f $me, $__.version | write-host;
[void]( hide-console );
do {
    $_refresh = $false;
    [void]( popUP );
